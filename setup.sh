...
echo -e "  3. Config-Check:                 ${GREEN}${BOLD}notectl doctor${NC}"
echo -e "     ${YELLOW}(warnt, falls vault_path noch auf dem Standardpfad steht statt deinem echten Vault)${NC}"
echo -e "  4. TUI starten:                  ${GREEN}${BOLD}notectl${NC}"
echo ""
